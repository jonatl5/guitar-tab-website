...
export default function Home() {
  ...
  const handleProcessUrl = useCallback(async (url: string, cookiesText?: string) => {
    ...
    // Future-ready: cookiesText is available but not sent to backend yet
    // When backend supports it, update the processYouTubeUrl call to include cookies_text
    void cookiesText; // Acknowledge the parameter for future use
